...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding text-center">
			...
			$worachat_theme_description = get_bloginfo( 'description', 'display' );
			if ( $worachat_theme_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $worachat_theme_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
			</div>
		</div><!-- .site-branding -->
